    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(children: [
          Positioned(top: -120, right: -80, child: _Glow(color: AppColors.accent, size: 320)),
          Positioned(bottom: -140, left: -100, child: _Glow(color: AppColors.accent, size: 360)),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Join RecruitIQ', textAlign: TextAlign.center, style: AppText.headline(26, color: Colors.white)),
                    const SizedBox(height: 6),
                    Text('Create your recruiter account', textAlign: TextAlign.center, style: AppText.body(13, color: Colors.white54)),
                    ...
                    _ProField(
                      ...
                      errorText: authVm.fieldErrors['name'],
                    ),
                    ...
                    Center(
                      child: GestureDetector(
                        ...
                        child: RichText(text: TextSpan(children: [
                          TextSpan(text: 'Already have an account? ', style: AppText.body(13, color: Colors.white38)),
                          TextSpan(text: 'Sign In', style: AppText.label(13, color: Colors.white70)),
                        ])),
                      ),
                    ),
                  ],
